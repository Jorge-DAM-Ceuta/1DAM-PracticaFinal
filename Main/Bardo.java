 ...
 * @return Devuelve un String con la informaci�n del Ataque del Bardo.
 */
    public String luchar(){
        return "El Bardo " + getNombre() + " ataca con " + getDanoTotal() + " puntos de dano";
    }
 ...
 */
    ...
    public void setEArma(Arma a){
        if(a.tipo.equals("Espada") || a.tipo.equals("Daga")){
            arma = new Arma(a);
        }
    }
