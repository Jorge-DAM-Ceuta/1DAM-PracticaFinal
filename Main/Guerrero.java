 ...
 */
    public Guerrero(){
        ...
        armadura = new ArrayList<>();
        artefacto = new ArrayList<>();
    }
 ...
 */
    public String luchar(){
        if(Furia==true){
            ...
            System.out.println("El Guerrero " + getNombre() + " ataca con " + getDanoTotal() + " puntos de dano");
        
            setAtaque(getAtaque()/2);
            
            return getNombre() + " esta furioso! Aumenta x2 los puntos de Ataque." + "\nEl Guerrero " + getNombre() + " ataca con " + getDanoTotal() + " puntos de dano";
        }else{
            return "El Guerrero " + getNombre() + " ataca con " + getDanoTotal() + " puntos de dano";
        }
    }
 ...
 */
    public String defender(){
        if(Furia==true){
            ...
            System.out.println("El Guerrero " + getNombre() + " tiene " + getVida() + " puntos de Vida, " + getBlindajeTotal() + " puntos de Armadura" + " y " + getResistenciaMagica() + " puntos de Resistencia Magica");        
            
            setArmadura(getArmadura()*2);
            setResistenciaMagica(getResistenciaMagica()*2);
            
            return getNombre() + " esta furioso! Tiene la mitad de puntos de Armadura y Resistencia Magica" + "\nEl Guerrero " + getNombre() + " tiene " + getBlindajeTotal() + " puntos de Armadura" + " y " + getResistenciaMagica() + " puntos de Resistencia Magica";        

        }else{
            return "El Guerrero " + getNombre() + " tiene " + getVida() + " puntos de Vida, " + getBlindajeTotal() + " puntos de Armadura" + " y " + getResistenciaMagica() + " puntos de Resistencia Magica";       
        }
    }
 ...
 */
    ...
    public void setEArma(Arma a){
        if(!a.nombre.equals("Cetro") && !a.nombre.equals("Arco") && !a.nombre.equals("Baston")){
            arma = new Arma(a);
        }
    }
    
    public void setEArmadura(Armadura a){
        if(a.tipo.equals("Metal")){
            for(Armadura elemento : this.armadura){
                if(elemento.pieza!=a.pieza){
                    armadura.add(a);
                }
            }
    ...
    public void setEArmaSecundaria(Arma a){
        if(!a.tipo.equals("Cetro") && !a.tipo.equals("Arco") && !a.tipo.equals("Baston")){
            if(arma.getEEmpunadura()=="Una mano" && a.getEEmpunadura()=="Una mano"){
                armaSecundaria = new Arma(a);
            }
        }
    }
    
    public Arma getEArmaSecundaria(){
