...
/**
    ...
    */
        public String devuelveClase(){
            return "Companero Animal";
        }
        
        public void setEArmadura(Armadura a){
            if(a.getEPieza().equals("Pechera") && a.getETipo().equals("Cuero")){
                armadura = new Armadura(a);
            }
        }
 ...
 */
    ...
    public void setEArma(Arma a){
        if(a.tipo.equals("Espada") || a.tipo.equals("Hacha") || a.tipo.equals("Daga") || a.tipo.equals("Arco")){
            arma = new Arma(a);
        }
    }
    
    public void setEArmadura(Armadura a){
        if(a.tipo.equals("Cuero")){
            for(Armadura elemento : armadura){
