 ...
 * @param ni Recibe un atributo de tipo int que inicializara el Nivel usando el Setter dise�ado para ello.
 */
 ...
 */
    public String luchar(){
        return "El Mago " + getNombre() + " ataca con " + getDanoTotal() + " puntos de da�o.";        
    }
 ...
 */
    ...
    public void setEArma(Arma a){
        ...
        if(a.tipo.equals("Cetro") || a.tipo.equals("Baston")){
            arma = new Arma(a);
        }
    }
    
    public void setEArmadura(Armadura a){
        if(a.tipo.equals("Tela")){    
